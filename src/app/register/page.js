      ...
      <div className="flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <motion.button
            ...
            whileHover={{ scale: 1.02 }}
            whileTap={{ scale: 0.98 }}
            className="w-full flex items-center justify-center gap-3 py-3 px-4 rounded-xl font-medium text-sm text-slate-200 bg-slate-950 border border-slate-800 hover:border-slate-700 hover:bg-slate-800/50 transition-all cursor-pointer"
          >
